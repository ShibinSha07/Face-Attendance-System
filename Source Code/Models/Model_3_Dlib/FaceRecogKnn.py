...
while True:
    ...
    #predictions = predict(frame_copy, model_path="C:\Users\Bassam EC\test\m3\DlibFaceRecognition\classifier\trained_knn_model.clf") # add path here
    predictions = predict(frame_copy, model_path=r"C:\Users\Bassam EC\test\m3\DlibFaceRecognition\classifier\trained_knn_model.clf") # add path here
